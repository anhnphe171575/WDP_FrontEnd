...
import { FaBlog, FaFlag, FaStar, FaHeadset } from "react-icons/fa";
...
const DashboardPage = () => {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto', fontFamily: 'Inter, Arial, sans-serif', background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div style={{ display: "flex", gap: 24, marginBottom: 36, flexWrap: 'wrap' }}>
        {[
          ...
          <div key={item.label} style={{
            ...
            <div>
              <div style={{ fontSize: 16, fontWeight: 600, color: '#555', marginBottom: 4 }}>{item.label}</div>
              <div style={{ fontSize: 28, fontWeight: 800, color: cardStyles[idx].color }}>{item.value}</div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div style={{ display: "flex", gap: 32, marginBottom: 40, flexWrap: 'wrap' }}>
        <div style={{ flex: 2, minWidth: 380, background: "#fff", borderRadius: 16, padding: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', marginBottom: 24 }}>
        ...
        <div style={{ flex: 1, minWidth: 320, display: "flex", flexDirection: "column", gap: 24 }}>
          <div style={{ background: "#fff", borderRadius: 16, padding: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
            ...
            <div style={{ color: '#888', fontSize: 14, marginBottom: 10 }}>Pie chart: Evaluate product/service quality.</div>
          ...
          <div style={{ background: "#fff", borderRadius: 16, padding: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
            ...
            <div style={{ color: '#888', fontSize: 14, marginBottom: 10 }}>Pie chart: Measure customer care effectiveness.</div>
            <ChartMarketing type="pie" data={[
      ...
      <div style={{ display: "flex", gap: 32, flexWrap: 'wrap' }}>
        <div style={{ flex: 1, minWidth: 320, marginBottom: 32 }}>
